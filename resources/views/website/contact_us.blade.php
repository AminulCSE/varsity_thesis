...
<div class="col-xs-12 col-sm-12 col-md-8 homebanner-holder"> 
    <div class="detail-block">
            ...
            @endif
              ...
              <form action="{{ url('user/send_contact') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <input type="subject" name="subject" class="form-control unicase-form-control text-input" id="email">
                  </div>

                  <div class="form-group">
                      <label class="info-title" for="phone_number">ফোন নাম্বার: <span></span></label>
                      <input type="phone_number" name="phone_number" class="form-control unicase-form-control text-input" id="phone_number">
                  </div>


                  <div class="form-group">
                      <label class="info-title" for="message">মেসেজ<span>*</span></label>
                      <textarea name="message" class="form-control unicase-form-control text-input" id="message"></textarea>
                  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3018.1637085501866!2d90.37629381434952!3d23.807411892514327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2sbd!4v1613445541976!5m2!1sen!2sbd" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </div>
        </div>
